...
const languageList = [
  ...
  },
  {
    name: "Gujarati",
    code: "gu-IN",
    image: require("@/assets/images/gujarat.jpeg"),
  },
  {
    name: "Tamil",
    code: "ta-IN",
    image: require("@/assets/images/tamil.jpeg"),
  },
  {
    name: "Hindi",
    code: "hi-IN",
  ...
  },
  {
    name: "Telugu",
    code: "te-IN",
    image: require("@/assets/images/Andhra.jpeg"),
  },
  {
    name: "Malayalam",
    code: "ml-IN",
...
export default function IndexScreen() {
  ...
  const { fontSizeMultiplier, changeFontSizeMultiplier } =
    useContext(FontSizeContext);
  const [fontSizeModalVisible, setFontSizeModalVisible] = useState(false);
  const { t, i18n } = useTranslation();
  const [modalVisible, setModalVisible] = useState(false);
  const [previewMultiplier, setPreviewMultiplier] =
    useState<number>(fontSizeMultiplier);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        >
          <TouchableOpacity onPress={openFontSizeModel}>
            <TextAa size={40 * fontSizeMultiplier} />
          </TouchableOpacity>
          <TouchableOpacity onPress={openmodel}>
            <Translate size={40 * fontSizeMultiplier} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => router.push("/Profile")}>
            <User size={40 * fontSizeMultiplier} />
          </TouchableOpacity>
        </View>
      </View>
      <Modal
      ...
      <View>
        <View style={styles.content}>
          <Text
            style={[styles.welcomeText, { fontSize: 40 * fontSizeMultiplier }]}
          >
            {t("home.welcome")}
          </Text>
          <Text
            style={[styles.subtitle, { fontSize: 24 * fontSizeMultiplier }]}
          >
            {t("home.subtitle")}
          </Text>
          <Text
            style={[styles.description, { fontSize: 16 * fontSizeMultiplier }]}
          >
            {t("home.description")}
          </Text>
          <Text
            style={[
              styles.exploringLanguages,
              { fontSize: 24 * fontSizeMultiplier },
            ]}
          >
        ...
        <SafeAreaView style={styles.modalContainer}>
          <View style={styles.modalcontent}>
            ...
            <View style={styles.sliderSectionContainer}>
              ...
              >
                This is a sample paragraph. You can see how the text size
                changes as you move the slider. Adjust it to find the most
                comfortable reading size for you. The quick brown fox jumps over
                the lazy dog.
              </Text>
              <Slider
                style={styles.slider}
